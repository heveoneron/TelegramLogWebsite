        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <a href="{{ route('list-logs.create') }}" class="btn btn-primary mb-4 inline-block bg-blue-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-blue-700 transition duration-200">
                        Tambah Data Log
                    </a>
                    ...
                    <table id="logs-table" class="display table-auto w-full border-separate border-spacing-0.5">
                        <thead class="bg-gray-200 dark:bg-gray-700">
                            <tr>
                                ...
                                <th class="p-3 text-left text-sm font-medium text-gray-800 dark:text-gray-200">Business Partner Name</th>
                                <th class="p-3 text-left text-sm font-medium text-gray-800 dark:text-gray-200">Description</th>
                                <th class="p-3 text-left text-sm font-medium text-gray-800 dark:text-gray-200">Date</th>
                                <th class="p-3 text-left text-sm font-medium text-gray-800 dark:text-gray-200">Status</th>
                            </tr>
                        </thead>
                        <tbody class="text-sm">
                            ...
                            $('#logs-table').DataTable({
                                ...
                                ajax: {
                                    ...
                                    error: function(xhr, error, code) {
                                        ...
                                        $('#logs-table').html('<p class="text-center">Data tidak ditemukan atau terjadi kesalahan.</p>');
                                    }
                                },
                                columns: [
                                    { data: 'id', name: 'id' },
